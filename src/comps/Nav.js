...
const Nav = () => {
  ...
  return (
    ...
    <img className="h-[35px] sm:h-[50px] md:h-[60px] w-[auto]" src={Logo} />
    <img
    ...
    />
    {showUserOption && (
      <div className="shadow-[0_8px_30px_rgb(0,0,0,0.12)] bg-white w-[120px] sm:w-[150px] h-[auto] p-[10px] sm:p-[20px] absolute right-5 top-[65px] sm:right-5 sm:top-[90px]">
        <button
